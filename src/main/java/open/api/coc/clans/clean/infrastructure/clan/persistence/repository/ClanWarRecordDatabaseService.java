...
public class ClanWarRecordDatabaseService implements ClanWarRecordRepository {
    ...
    @Override
    public List<ClanWarMemberRecordDTO> findAll(ClanWarType type, LocalDateTime from, LocalDateTime to, Pageable pageable) {
    ...
    @Override
    public List<ClanWarMemberRecordDTO> findAllByClanTag(String clanTag, ClanWarType type, LocalDateTime from, LocalDateTime to, Pageable pageable) {
        ClanWarRecordConditionBuilder condition = new ClanWarRecordConditionBuilder(type, from, to);
