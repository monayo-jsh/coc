...
const URI_RAID_MISSING_ATTACK_PLAYERS = '/raid/missing/attack'; // 이번 시즌 미공자 조회
...
async function fetchRaidMissingAttackPlayers() {
  return await axios.get(URI_RAID_MISSING_ATTACK_PLAYERS)
                    .then((response) => {
                      const { data } = response
                      return data;
                    })
